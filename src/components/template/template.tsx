        ...
        <div className="flex flex-col justify-center items-center w-[90%]">
            ...
            <div className="flex gap-3 mt-5">
                ...
                <IconButton href="https://github.com/LuizHenri16">
                    <img className="w-12" src="/icons/github-icon.svg" alt="icone-github" />
                </IconButton>
                   
                <IconButton href="https://www.instagram.com/_._luizhenrique/" >
                    <img className="" src="/icons/instagram-icon.svg" alt="icone-instagram" />
                </IconButton>
                   
                <IconButton href="https://www.linkedin.com/in/luiz-bastos-395922213/">
                    <img className="" src="/icons/linkedin-icon.svg" alt="icone-linkedin" />
                </IconButton>
