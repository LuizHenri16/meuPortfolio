    ...
    return (
        <section id="projetos" className="mt-10 md:mt-20 max-w-[1120px] mx-auto px-4">
            ...
            <div className="grid grid-cols-1 gap-6 mt-5 sm:grid-cols-1 md:grid-cols-2">
                ...
                <ProjectCard pageUrl="/projetos/mytasks" name="MyTasks" resume="Projeto para gerenciamento de tarefas." stack="Mobile" stacks={["ReactNative", "TypeScript"]} src="/images/mytaskProjetoCompleto.png" />
