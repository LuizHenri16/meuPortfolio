        ...
        <section className="mt-10 md:mt-20 max-w-[1120px] mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                    ...
                    <p className="font-[Sora] text-sm text-text2 font-light leading-relaxed max-w-lg tracking-wider">
                        Desenvolvedor Full Stack com 3 anos de experiência em projetos comerciais e 5 anos de estudo em desenvolvimento de software. Foco em construir produtos completos, de APIs robustas com NestJS a interfaces modernas com Next.js.
                    </p>
