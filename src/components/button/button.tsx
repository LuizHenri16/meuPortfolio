...
export const NavButton: React.FC<NavButtonProps> = ({ iconUrl, text, onClick }: NavButtonProps) => {
    return (
        <button onClick={onClick} className="flex flex-row items-center justify-center gap-2 bg-white px-2 py-1 border-2 border-gray-50 cursor-pointer duration-200 hover:border-terracota-100 hover:bg-[#FFF5F6] rounded-2xl lg:py-2">
