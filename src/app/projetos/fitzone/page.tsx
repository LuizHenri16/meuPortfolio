...
export default function Fitzone() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF9] font-[Roboto] py-10 px-5 flex justify-center">
      ...
      <div className="w-full max-w-4xl bg-white border-1 border-terracota-100 rounded-3xl shadow-xl overflow-hidden p-8 md:p-12">

        <div className="flex items-center mb-8">
          <a
            className="group flex items-center gap-2 font-bold text-terracota-100 transition-all hover:text-[#7a464c]"
            href="/projetos"
          >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-terracota-100 mb-4">
            FitZone - Gestão de Academias
          </h1>

          <h3 className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">
            O<span className="font-bold text-terracota-100"> FitZone</span> é um sistema focado na administração completa e eficiente de academias e estúdios fitness.
          </h3>
        </div>

        <hr className="my-10 border-gray-100" />
        <div className="flex flex-col">
          <h2 className="text-2xl font-bold mb-6 text-center md:text-left text-terracota-100">
        ...
        <div className="flex flex-col items-center">
          <p className="text-terracota-100 font-mono text-sm uppercase tracking-widest mb-6 border border-terracota-100 px-3 py-1 rounded-full">
            Galeria do Sistema
          </p>
        ...
        <div className="mt-12 flex justify-center">
          <a
            className="flex items-center gap-3 bg-[#E7FFFA] text-terracota-100 px-8 py-4 rounded-xl font-bold shadow-lg hover:bg-[#9be0d1] hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
